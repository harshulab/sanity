...
String serverName = "http://192.168.43.58:8000/home";
const char* ssid = "ASUS_X00TD";
const char* password = "asingh00489";
...
void loop() {
   ...
   if(hand_distance<25 && depth<=26)        //and because we only want to spray when tank is full
   ...
   if (depth>26 && email_trigger == 0){           //send email only when hand is not placed, tank is empty and its first time that conditions are met
